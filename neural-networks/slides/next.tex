...
% Draw the letters with better spacing
\node[draw, rectangle, thick, minimum width=1cm, minimum height=1cm, fill=lightblue!20] at (0,0) {\Large \textbf{a}};
\node[draw, rectangle, thick, minimum width=1cm, minimum height=1cm, fill=lightblue!20] at (1.5,0) {\Large \textbf{p}};
\node[draw, rectangle, thick, minimum width=1cm, minimum height=1cm, fill=lightblue!20] at (3,0) {\Large \textbf{p}};
\node[draw, rectangle, thick, minimum width=1cm, minimum height=1cm, dashed, color=red, fill=red!10] at (4.8,0) {\Large \textbf{?}};

% Add arrow with better positioning
\draw[->, thick, red] (4.8, -0.8) -- (4.8, -1.5);
\node[color=red, align=center] at (4.8, -2) {\textbf{What comes\\next?}};
\end{tikzpicture}
\end{center}
