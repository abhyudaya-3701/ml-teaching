...
Gain(S, Outlook) $=$ Entropy(S) $-$ $(5/14) \times$ Entropy($S_{\text{Sunny}}$) $-$ $(4/14) \times$ Entropy($S_{\text{Overcast}}$) $-$ $(5/14) \times$ Entropy($S_{\text{Rain}}$)

$= 0.940 - (5/14) \times 0.971 - (4/14) \times 0 - (5/14) \times 0.971$
