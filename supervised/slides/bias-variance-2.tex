...
Here, the true function $f_{\vtheta_{\text{true}}}$ is used to model the relation $y_t = f_{\vtheta_{\text{true}}}(x_t)$
\begin{figure}
...
\only<2-2>{Because of this, data is inherently noisy.}
\only<3-4>{This is \textbf{not} a property of data but rather an \textbf{irreducible error}.}

\only<4-4>{
This error can be captured by the error term $\epsilon$ which causes the final value of the house to follow the equation: $y_t = f_{\vtheta_{\text{true}}}(x_t) + \epsilon_t$
}

\only<5->{This noise can be assumed to be mean-centered around $0$ with spread called the variance of the noise. 
...
\only<2>{\begin{figure}
\includegraphics[width=0.7\textwidth]{../assets/bias-variance/figures/biasn_1.pdf}
\vspace*{-0.3cm}
...
\only<2>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bias1.pdf}
\vspace*{-0.3cm}
...
\only<3>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bias2.pdf}
\vspace*{-0.3cm}
\caption{Two Datasets from same relation}
\end{figure}}
...
\only<4>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bias3.pdf}
\vspace*{-0.3cm}
\caption{Two Datasets from same relation}
\end{figure}}
...
\only<1->{$$\text{Bias}(x) = f_{\vtheta_{\text{true}}}(x) - f_{\bar{\vtheta}}(x)$$}
\only<2->{It is a measure of how flexible the fit is in capturing $f_{\vtheta_{\text{true}}}(x)$}
\only<1->{\begin{figure}
...
\only<1>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bias7.pdf}
\vspace*{-0.3cm}
\caption{Effect of degree on Bias of the fit}
\end{figure}}
\only<2>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bias8.pdf}
\vspace*{-0.3cm}
\caption{Effect of degree on Bias of the fit}
\end{figure}}
\end{frame}
...
\only<1>{\begin{figure}
\includegraphics[width=\textwidth]{../assets/bias-variance/figures/bv-2.pdf}
\vspace*{-0.3cm}
\caption{Variance in high complexity fits}
\end{figure}}
