...
\begin{frame}{Introduction}
\vspace{0.4cm}
\only<1>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/lin_1.pdf}\caption{Base Data Set}
\end{figure}}
\only<2>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/lin_plot_1.pdf}\caption{Fit with Degree 1}
\end{figure}}
\only<3>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/lin_plot_3.pdf}\caption{Fit with Degree 3}
\end{figure}}
\only<4>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/lin_plot_6.pdf}\caption{Fit with Degree 6}
\end{figure}}
\only<5>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/lin_plot_11.pdf}\caption{Fit with Degree 11}
\end{figure}}
\end{frame}  
...
\begin{figure}
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\linewidth]{../assets/ridge/figures/ridge_base_contour.pdf}
                \caption{Contour Plot}
        \end{subfigure}%
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\linewidth]{../assets/ridge/figures/ridge_base_surface.pdf}
...
\vspace{0.4cm}
\only<1>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/ridge_1.pdf}\caption{$\mu = 1$}
\end{figure}}
\only<2>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/ridge_10.pdf}\caption{$\mu = 10$}
\end{figure}}
\only<3>{\begin{figure}\includegraphics[width=0.8\linewidth]{../assets/ridge/figures/ridge_1000.pdf}\caption{$\mu = 1000$}
\end{figure}}
\end{frame}
...
\begin{column}{0.4\textwidth}
\begin{figure}
\includegraphics[width=\linewidth]{../assets/ridge/figures/ridge_new_0_17.pdf}
\end{figure}
...
\begin{column}{0.4\textwidth}
\begin{figure}
\includegraphics[width=\linewidth]{../assets/ridge/figures/ridge_new_1_17.pdf}
\end{figure}
Fit High Order Polynomial \\
...
\vspace{-0.6cm}
\begin{figure}
%\includegraphics[width=\linewidth]{../assets/ridge/figures/temp.pdf} % File missing
\end{figure}
\end{frame}
