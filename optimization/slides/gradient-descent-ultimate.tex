...
\begin{document}
  ...
  \begin{frame}{Step 2a: Computing $\nabla L = \nabla \frac{1}{n}\sum_{i=1}^n \ell(f(\vx_i;\vtheta),y_i)$}
    \begin{center}
    \begin{tikzpicture}[
        node distance=1.5cm,
    ...
    \node at (6,0.5) {\scriptsize Sum all losses};
    \node at (9,0.5) {\scriptsize Take gradient};
    \end{tikzpicture}
    \end{center}
  ...
  \begin{frame}{Step 2b: Using Linearity $= \frac{1}{n}\sum_{i=1}^n \nabla \ell(f(\vx_i;\vtheta),y_i)$}
    \begin{center}
    \begin{tikzpicture}[
        node distance=1.5cm,
        sample/.style={rectangle, draw=blue, fill=blue!10, thick, minimum width=1.2cm, minimum height=0.8cm},
  ...
  \begin{frame}{Step 2c: The Equivalence - Linearity of Gradient}
