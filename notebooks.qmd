...
- [Autograd from scratch](notebooks/autograd-from-scratch.ipynb) - Computing gradients efficiently
- [2nd Order Logistic Regression](notebooks/logistic-torch-second-order.ipynb)
